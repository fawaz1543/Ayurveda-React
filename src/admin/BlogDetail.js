...
<div className="row" >
              <div class="col-md-2 pt-3 mt-3" style={{ 'height': '90vh' , 'background-color': '#EAEAEA' , 'text-align' : 'center' , 'border-radius': '0px 20px 20px 0px' }}>
                  ...
                  <ul class="adminlist">
                    <br/>
                    <li ><a href="/adminBlogList">Blog List Page</a></li>
                    <hr/>
                    <li class="active"><a href="/adminBlogDetail" >Blog Detail Page</a></li>
                    <hr/>
              ...
              <div class="col-md-10" style={{ 'background-color' : '#ffffff' }}>
                  <div class="col-md-12 dashboard-right-section pt-3">
                   <div class="pt-2" style={{ 'background-color':'rgb(109 161 46)' , 'border-radius' : '5px'  }}>
                    <h3 class="p-2" style={{ 'font-size' : '20px' , 'font-weight': 'bold' , 'color' : '#fff'  }}>Blog Detail List Page</h3>
                    </div>

                    <div class="row">
                    <h4 class="pt-5 pl-5" >Enter Details for Blog Detail List Page</h4>
                    </div>
